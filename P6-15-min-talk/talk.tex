...
\end{frame}
\note{To write and maintain code efficiently, we need documentation. Usually, code is composed of several code files, and each code file contains a string of charactors. Basically the string conforms to the syntax of certain languages like C, Java, and etc.. Compared to code, documentation is much more complicated. It may be in different file formats, like pdf, html, MS word, and etc.. Instead of raw ASCII string, the content in documentation could be text, table, picture, and etc..}
